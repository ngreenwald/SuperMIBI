# Mostly same as Care_Model.py
# Change location where results are saved, add timer, save epoch metrics to JSON
# Change kernel size with unet_kernel_size option in Config function
