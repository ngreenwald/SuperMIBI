...
h5_x_cropped = h5py.File('x_cropped.h5', 'w')
h5_y_cropped = h5py.File('y_cropped.h5', 'w')
...
x_data_reload = h5py.File('x_cropped.h5', 'r')
y_data_reload = h5py.File('y_cropped.h5', 'r')
...
# create model
model_1 = Models.SuperMIBI_1((128, 128, 1))
...
model_1.history = model_1.fit_generator(datagen.flow(x_train[:, :, :, -2:-1], y_train[:, :, :, -2:-1], batch_size=32), epochs=2)
